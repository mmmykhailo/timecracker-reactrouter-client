 ...
 * Patch report
 */
export const patchReportsById = <ThrowOnError extends boolean = false>(options: Options<PatchReportsByIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).patch<PatchReportsByIdResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
