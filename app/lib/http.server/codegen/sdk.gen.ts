 ...
 * Daily durations
 */
export const getReportsDailyDurations = <ThrowOnError extends boolean = false>(options: Options<GetReportsDailyDurationsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetReportsDailyDurationsResponse, unknown, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
